...
nnoremap <Leader>gh :execute 'tabnew <bar> 0r !git log -L <C-r>=line(".")<CR>,<C-r>=line(".")+1<CR>:#'<CR>:set filetype=git<CR>
vnoremap <Leader>gh :<C-u>execute 'tabnew <bar> 0r !git log -L <C-r>=line("'<")<CR>,<C-r>=line("'>")<CR>:#'<CR>:set filetype=git<CR>
