...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:foreground "#E0E0E0" :background "#202020" :family "Inconsolata" :foundry "CYRE" :slant normal :weight normal :height 105 :width normal))))
 '(linum ((t (:background "#000000" :foreground "#777777")))))
