-------------------------------------------
-- Purescript-specific neovim configuration
-------------------------------------------
...
vim.cmd([[
  ...
  " -----------------------------------------------------------------------------
  " Apply workspace-specific Purescript settings, if available;
  " this is placed at the end to make sure workspace configuration takes priority
  " and possibly overrides our stock mappings (including the above)
  " -----------------------------------------------------------------------------

  if filereadable(expand("~/.workspace-purescript.vim"))
      source ~/.workspace-purescript.vim
  endif
]])
