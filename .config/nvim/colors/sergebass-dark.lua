...
vim.cmd([[
  ...
  " nvim-navic
  hi NavicText cterm=bold ctermfg=226 gui=bold guifg=#ffff00
  hi NavicSeparator cterm=NONE ctermfg=255 gui=NONE guifg=#eeeeee

  " Individual icons for different symbol types
