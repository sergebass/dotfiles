...
return {
  ...
  -- Improved fzf.vim written in lua 
  {
    ...
    config = function()
      ...
      vim.keymap.set({'n', 'v'}, "<Space><Space>", fzfLua.commands, { desc = "Commands (fzf-lua)" })
      vim.keymap.set({'n', 'v'}, "<Space><Space>?", fzfLua.command_history, { desc = "Command history (fzf-lua)" })
